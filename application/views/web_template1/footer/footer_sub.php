    ...
    <div id="index-contact">
        <div class="container">
           <div class="col-md-6 contact-detail">
                ...
                <p>
                    <a href="<?php echo $site['WD_FbLink']; ?>" target="_blank"><img src="<?php echo base_url('assets/images/facebook-icon.png');?>" alt=""></a>
                    <a href="<?php echo $site['WD_Ytlink']; ?>" target="_blank"><img src="<?php echo base_url('assets/images/youtube-icon.png');?>" alt=""></a>
                </p>
                <p>
