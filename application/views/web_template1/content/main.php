				...
				<a href="<?php echo base_url('main/product_details/'.$value['P_ID']); ?>" title="<?php echo $value['P_Name']; ?>"> <?php
					...
					<div class="wrap_content_img">
						<div class="<?php echo $layout; ?>"> <?php
							if (isset($value['P_Img']) && $value['P_Img'] !== '') { ?>
								<img src="<?php echo base_url('assets/uploads/user_uploads_img/'.$value['P_Img']); ?>" title="<?php echo $value['P_Name']; ?>"> <?php
							} 
							else { ?>
								<img src="<?php echo base_url('assets/images/noimage.gif'); ?>" title="<?php echo $value['P_Name']; ?>"> <?php
							} ?>
						</div>
					</div>
